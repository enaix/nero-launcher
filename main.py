...
def main():
    ...
    window.title('nero')
    window.tk.call('wm', 'iconphoto', window._w, tk.PhotoImage(file=config.parser['WindowIconPath']))
    ...
    style.map('WF.TButton', background=[('pressed', config.parser['FocusedButtonPressedBackgroundColor']), ('active', config.parser['FocusedButtonActiveBackgroundColor'])])
    style.map('WF.TButton', foreground=[('pressed', config.parser['FocusedButtonPressedForegroundColor']), ('active', config.parser['FocusedButtonActiveForegroundColor'])])
