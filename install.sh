...
echo "This script will install nero executable."

read -p "Default installation folder is /usr/bin. Would you like to change it? [y/N]" USER_INPUT
...
echo "The script was succesfully installed"
